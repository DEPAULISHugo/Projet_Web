...
INSERT INTO objets (id, nom, latitude, longitude, zoom, icone, texte) VALUES (0, 'touriste', 16.0156206, -61.7127824, 1, 'touriste.png', 'Il faut absolument de dépêcher, la situation est critique ! Pour trouver l''antidote, tu vas avoir besoin d''un code. J''ai une partie de ce code dans ma valise, mais je crois que je l''ai oublié à l''aéoroport. Retrouve la et ramène la moi pour que je puisse t''aider.');
